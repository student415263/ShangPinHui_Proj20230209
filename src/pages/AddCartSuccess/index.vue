...
<script>
  export default {
    ...
    mounted(){
      ...
      /*skuInfo用会话存储，不用query传递skuInfo :*/  // console.log("query: skuInfo, skuNum::", this.$route.query); //query传参也行，但路径显示的很复杂，所以不用
      console.log(
        "query: skuInfo, skuNum::", 
        /*字符串转成对象：*/
        JSON.parse(sessionStorage.getItem("SKUINFO")) //把这玩意计算一下
      ); //OK
